...
urlpatterns += patterns('website.cardstories.views',
    ...
    (r'^logout/', 'logout'),
    (r'^facebook/', 'facebook'),
    (r'^get-extra-cards/', 'get_extra_cards_form'),
    (r'^%s' % settings.PAYPAL_IPN_PATH, include('paypal.standard.ipn.urls')),
    (r'^%s' % settings.PAYPAL_PDT_PATH, 'after_bought_cards'),
    (r'^activity-notifications/unsubscribe/', 'activity_notifications_unsubscribe'),
