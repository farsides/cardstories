...
# -*- coding: utf-8 -*-
#
# Copyright (C) 2010 hunterford - http://djangosnippets.org/users/hunterford/
#
# Any third party who sees the code is granted a royalty-free, non-
# exclusive license to copy and distribute that code and to make and 
...
class EmailMultiRelated(EmailMultiAlternatives):
    ...
    messages, like including text and HTML versions with inline images.
    
    From http://djangosnippets.org/snippets/2215/
    """
